...
{ 
    ...
    if (serial->open(QIODevice::ReadWrite))
    {
        ...
        //Open Logfile
        QString filename="/home/pi/Medflux/log/MethodLog-" + QDateTime::currentDateTime().toString()+".txt";
...
{
    // change to pulse for new Medflux pump handling
    sendSetOut(true);
    QTest::qWait(500);
    sendSetOut(false);
}
...
{
    //sendSetOut(false);   No longer necessary with Medflux
}
